...
public record BeaconDataEntry(
	...
	[property: JsonPropertyName("installationsUnlocked")] IReadOnlyList<string> InstallationsUnlocked,
	[property: JsonPropertyName("name")] string Name,
	[property: JsonPropertyName("playExperienceNameDLR")] string PlayExperienceNameDLR,
	[property: JsonPropertyName("playExperienceNameWDW")] string PlayExperienceNameWDW,
	[property: JsonPropertyName("type")] string Type,
	[property: JsonPropertyName("waypointId")] int WaypointId
);
...
public record MapObjectDataEntry(
	...
	[property: JsonPropertyName("type")] string Type,
	[property: JsonPropertyName("mapSizeProportion")] double? MapSizeProportion,
	[property: JsonPropertyName("text")] string Text,
	[property: JsonPropertyName("beaconId")] string BeaconId,
	[property: JsonPropertyName("label")] string Label,
	[property: JsonPropertyName("jobIds")] IReadOnlyList<string> JobIds,
	[property: JsonPropertyName("locationKey")] string LocationKey,
	[property: JsonPropertyName("installationIds")] IReadOnlyList<string> InstallationIds
);
...
public record PdpBeaconPayload(
	[property: JsonPropertyName("name")] string? Name,
	[property: JsonPropertyName("experienceName")] string? ExperienceName,
...
public class DeviceParser
{
	...
	public static string ParseDroidRemoteBeacon(byte[] data)
	{
		var zero = data[0];
		var uuid = Guid.Parse(Convert.ToHexString(data[1..]));

		return $"DroidRemote[UUID={uuid:D}]";
	}
}
...
public class Program
{
	...
	public static void MainDumpAllAdTypes(string[] args)
	{
		...
		// Load GPS data
		using var gpsStream = File.OpenRead(@"X:\SWGE\gps_637956226262456597.bin");
		...
		// Load BLE data
		using var bleStream =
			File.OpenRead(@"X:\SWGE\ble_sniffer_637956226262456597.bin");
		...
		using var sw = new StreamWriter(@"X:\SWGE\ble_extracted_payloads_by_mac.txt");
			...
			while (stream.Position != stream.Length)
			{
				...
				switch (deviceType)
				{
					...
					case 0x10:
						...
						break;
					case 0x0F:
						str += $" {DeviceParser.ParseDroidRemoteBeacon(payload)}";
						break;
				}
